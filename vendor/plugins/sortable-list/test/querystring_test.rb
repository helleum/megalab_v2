...
class QueryStringTest < Test::Unit::TestCase
  ...
  # Should not occur normally (params are always strings) but a
  # before_filter may convert it or a non-string may be passed in
  # during functional testing.
  def test_nonstring_params
    assert_nothing_raised do
      assert_equal 'foo=1', {:foo => 1}.to_qs
    end
  end
end
