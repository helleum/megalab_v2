...
REPORT_SQL
    ...
    def lab_machine_usage_query(from, to)
      lab_machine_usage_sql = <<REPORT_SQL
        ...
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 000000 AND 005959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 000000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 000000)), 1, 0)) AS "00:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 010000 AND 015959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 010000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 010000)), 1, 0)) AS "01:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 020000 AND 025959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 020000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 020000)), 1, 0)) AS "02:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 030000 AND 035959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 030000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 030000)), 1, 0)) AS "03:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 080000 AND 085959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 080000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 080000)), 1, 0)) AS "08:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 090000 AND 095959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 090000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 090000)), 1, 0)) AS "09:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 100000 AND 105959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 100000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 100000)), 1, 0)) AS "10:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 110000 AND 115959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 110000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 110000)), 1, 0)) AS "11:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 120000 AND 125959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 120000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 120000)), 1, 0)) AS "12:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 130000 AND 135959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 130000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 130000)), 1, 0)) AS "13:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 140000 AND 145959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 140000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 140000)), 1, 0)) AS "14:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 150000 AND 155959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 150000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 150000)), 1, 0)) AS "15:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 160000 AND 165959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 160000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 160000)), 1, 0)) AS "16:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 170000 AND 175959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 170000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 170000)), 1, 0)) AS "17:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 180000 AND 185959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 180000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 180000)), 1, 0)) AS "18:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 190000 AND 195959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 190000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 190000)), 1, 0)) AS "19:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 200000 AND 205959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 200000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 200000)), 1, 0)) AS "20:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 210000 AND 215959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 210000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 210000)), 1, 0)) AS "21:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 220000 AND 225959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 220000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 220000)), 1, 0)) AS "22:00",
        SUM(IF((DATE_FORMAT(AcctStartTime, "%H%i%s") BETWEEN 230000 AND 235959) OR ((DATE_FORMAT(AcctStopTime, "%H%i%s") >= 230000) AND 
        (DATE_FORMAT(AcctStartTime, "%H%i%s") <= 230000)), 1, 0)) AS "23:00"
        FROM
        (SELECT UserName, user_id, Min(AcctStartTime) as AcctStartTime, Max(AcctStopTime) as AcctStopTime,
        AcctSessionTime, AcctTerminateCause, CallingStationID
        FROM radius.radacct
        WHERE AcctStartTime BETWEEN '#{from}' AND '#{to}'
        GROUP BY CallingStationID, DATE_FORMAT(AcctStartTime, "%d %m %Y")
        ORDER BY UserName, AcctStartTime) as s
        WHERE UserName NOT IN ('g0001', 'tc001')
...
REPORT_SQL
    ...
    def user_usage_csv(from, to)
      queries = user_usage_query_without_grouping(from, to)
      date_from = Date.parse(from).to_time
      report = StringIO.new
      CSV::Writer.generate(report, ',') do |csv|  
        csv << ""
        ...
        csv << ""
        csv << ""
        csv << ['ID Card No 1','Full Name', 'Seat No', '00:00', '01:00', '02:00', '03:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00' ]
        queries.each do |h|
          csv << [h.fetch("idcard_no1"), h.fetch("full_name"), h.fetch("display_name"), h.fetch("00:00"), h.fetch("01:00"), h.fetch("02:00"), h.fetch("03:00"), h.fetch("08:00"), h.fetch("09:00"), h.fetch("10:00"), h.fetch("11:00"), h.fetch("12:00"), h.fetch("13:00"), h.fetch("14:00"), h.fetch("15:00"), h.fetch("16:00"), h.fetch("17:00"), h.fetch("18:00"), h.fetch("19:00"), h.fetch("20:00"), h.fetch("21:00"), h.fetch("22:00"), h.fetch("23:00") ]
        end  
      end
      report
    end
